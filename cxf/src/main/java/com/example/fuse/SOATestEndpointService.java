 ...
 * 2021-11-19T12:24:22.799-06:00
 * Generated source version: 3.4.5
 *
 */
@WebServiceClient(name = "SOATestEndpointService",
                  wsdlLocation = "file:/Users/oscar/Projects/fuse6/cxf/src/main/resources/wsdl/test.wsdl",
                  targetNamespace = "http://example.fuse.com")
public class SOATestEndpointService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://example.fuse.com", "SOATestEndpointService");
    public final static QName SOATestEndpoint = new QName("http://example.fuse.com", "SOATestEndpoint");
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/oscar/Projects/fuse6/cxf/src/main/resources/wsdl/test.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SOATestEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/Users/oscar/Projects/fuse6/cxf/src/main/resources/wsdl/test.wsdl");
        }
        WSDL_LOCATION = url;
    }
